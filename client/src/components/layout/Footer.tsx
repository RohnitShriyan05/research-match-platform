      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold text-gray-900">AcadBond</span>
            </Link>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:contact@AcadBond.com" className="text-sm text-gray-600 hover:text-research-600 transition-colors">
                  contact@AcadBond.com
                </a>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row md:justify-between items-center">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} AcadBond. All rights reserved.
          </p>
