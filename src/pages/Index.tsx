...
const Index = () => {
  ...
  const testimonials = [
    {
      quote: "ResearchMatch helped me find the perfect research assistant for my project on climate change modeling.",
        ...
        <section className="section bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-gray-600">
                Success stories from professors and students using ResearchMatch
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-research-100 mb-8">
                Join ResearchMatch today and connect with the perfect research partner.
              </p>
